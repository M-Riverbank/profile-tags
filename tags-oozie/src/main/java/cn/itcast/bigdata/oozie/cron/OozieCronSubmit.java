package cn.itcast.bigdata.oozie.cron;
...
public class OozieCronSubmit {
	...
	public static void main(String[] args) throws OozieClientException, InterruptedException {
		...
		// 2.4. 定时任务设置
		jobConf.setProperty("start", "2022-11-21T09:00+0800");
		jobConf.setProperty("freq", "0 9 * * *");
		jobConf.setProperty("end", "2022-11-28T09:00+0800");
