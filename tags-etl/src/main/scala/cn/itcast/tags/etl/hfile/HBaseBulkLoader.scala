...
object HBaseBulkLoader {
  ...
  def main(args: Array[String]): Unit = {
    ...
    */
    ...
    val Array(dataType, tableName, family, inputDir, outputDir) = Array("3", "tbl_tag_orders", "detail", "/user/hive/warehouse/tags_dat.db/tbl_orders", "/datas/output_hfile/tbl_tag_orders")
